(use-package mu4e
  ...
  (use-package mu4e-thread-folding
    :load-path (lambda () (expand-file-name "~/.emacs.d/.local/lambda-library/lambda-user/mu4e-thread-folding" user-emacs-directory))
    :after mu4e
    :bind
        ...
        (list
         (make-mu4e-context
          ...
          :vars '((mu4e-sent-folder . "/gmail/Sent Mail")
                  ...
                  (user-mail-address . "dagnachewa@gmail.com") ; Prerequisite: Set this to your email
                  (mu4e-compose-format-flowed . t)
                  (smtpmail-queue-dir . "~/Maildir/gmail/queue/cur")
                  (message-send-mail-function . smtpmail-send-it)
                  (smtpmail-smtp-user . "dagnachewa") ; Set to your username
...
(provide 'lem-setup-mail)
;;; lem-setup-mail.el ends here
