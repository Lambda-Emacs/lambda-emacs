...
12. A writing-centric configuration with great citation support, markdown, [[https://github.com/jgm/pandoc][pandoc]],
    [[https://github.com/mclear-tools/consult-notes][dedicated functions for notes]], and org-mode 
...
- *Org*: Writing, Project management, TODOs, Literate programming. What doesn't
  ...
  The interested user might want to consult my [[https://github.com/mclear-tools/dotemacs/blob/master/.local/lambda-library/lambda-user/cpm-setup-org.el][dotfiles org setup]] as well as the
